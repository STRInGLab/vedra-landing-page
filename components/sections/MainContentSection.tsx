...
export const MainContentSection = (): JSX.Element => {
  return (
    <section className="relative z-0 flex flex-col w-full items-center pt-24 md:pt-32 lg:pt-48 xl:pt-60 pb-[200px] sm:pb-[300px] md:pb-[350px] lg:pb-[450px] px-4 sm:px-6 md:px-12 lg:px-16 bg-[linear-gradient(205deg,rgba(0,0,0,1)_0%,rgba(36,72,128,1)_20%,rgba(0,27,102,1)_30%,rgba(0,0,0,1)_40%,rgba(0,0,0,1)_50%,rgba(0,0,0,1)_60%,rgba(0,27,102,1)_70%,rgba(36,72,128,1)_80%,rgba(0,0,0,1)_100%)] [mask-image:linear-gradient(to_bottom,black_calc(100%-75px),transparent_100%)]">
      <div className="absolute -bottom-2 left-0 right-0 h-[110px] bg-gradient-to-t from-white via-white/70 to-transparent z-10 blur-xxl"></div>
